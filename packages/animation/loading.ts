...
/**
 * @param duration This value must be greater than 0. Default is `2`.
 * @param opacity This value must be greater than 0. Default is `0.4`.
 */
...
/** @param time This value must be greater than 0. Default is `1.5`. */
